...
expect_equal(res$col_names[3:4], c("x1_x_x2b", "x1_x_x2c"), info = "interaction expands factor")
...
expect_equal(res$col_names, "x1_x_x3", info = "numeric × numeric interaction name")
